...
dset_dir = '/home/feet/Documents/LAWN/datasets/SSF'
...
# dataset = dsets.Webcams.Webcams_cls(dset_dir, transformer=lambda x:x, limits={1.0:200, 1.25:200, 1.5:0, 1.75:185, 2.0:185, 2.25:30, 2.5:0, 3.0:400, 4.0:400, 5.0:400, 6.0:400, 7.0:400, 8.0:400, 9.0:400, 10.0:400})
dataset = dsets.SSF.SSF_cls(dset_dir, lambda x:x, limits={1.0:200, 2.0:200, 3.0:200, 4.0:200, 5.0:200, 6.0:200, 7.0:200, 8.0:200, 9.0:200, 10.0:200})
