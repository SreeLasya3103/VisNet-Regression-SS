...
example_img = '/home/feet/Desktop/picsforowen2/cropped_resized/SITE19_ORNT260_VIS4mi.png'

model_name = "bestrmep_softmax"
...
model = WithSoftmax()
model.model.load_state_dict(torch.load('/home/feet/Documents/LAWN/Visibility-Networks/rewrite2/runs/BestRMEP/best-loss.pt', weights_only=False, map_location=torch.device('cpu')))
model.eval()
...
rand_in = torch.unsqueeze(io.read_image(example_img, io.ImageReadMode.RGB)/255, 0)
